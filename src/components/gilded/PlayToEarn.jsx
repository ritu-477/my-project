...
const PlayToEarn = () => {
    return (
        <div className="lg:pt-[65px] lg:pb-[50px] pb-[48px] relative">
            ...
            <div className="container max-w-[1360px] mx-auto">
                <div className="flex justify-center mx-auto flex-col">
                    <h2 className="sm:text-5xl sm:leading-[61px] text-[28px] leading-[39px] text-white font-Josefin font-bold mb-4 text-center">
                        Play To <span className="text-gradient-blue">Earn</span>
                    </h2>
                    <p className="sm:text-[20px] text-base leading-6 text-white font-poppins font-normal sm:leading-[32.9px] text-center mx-auto opacity-70 max-w-[1024px]">
