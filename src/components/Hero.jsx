      ...
      <div className='container lg:pt-[109px] md:pt-20 sm:pt-16 pt-8'>
        <div className='flex lg:flex-row gap-1 flex-col w-full'>
          <div className='flex flex-col lg:w-[612px] w-full max-lg:justify-center max-lg:items-center'>
            ...
            <div className='rounded-tr-[100px] rounded-br-[100px] rounded-bl-[70px] bg-white flex justify-between max-w-[476px] w-full py-[9px] ps-[22px] pr-[9px] border border-gray'>
